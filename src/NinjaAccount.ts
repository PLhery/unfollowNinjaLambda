...
export class NinjaAccount {
     ...
     * @returns Promise with no data
     */
    sendUnfollow(id: string): Promise<void> {
        // TODO
    ...
    get(userId: string): Promise<Account> {
        return new Promise((resolve, reject) => {
            ...
            docClient.get(params, (err, data: {Item: Account}) => {
     ...
     */
    getUnfollowers(): Promise<{newFollowers: string[], unfollowers: string[]}> {
